...
export function registerCoreSiteInfo() {
    registerAbility('core/get-site-info', {
        ...
        parseIntent: (message) => {
            ...
            if (lowerMessage.includes('url') || lowerMessage.includes('address')) {
                fields.push('url');
            }
            if (lowerMessage.includes('tagline') || lowerMessage.includes('description')) {
                fields.push('description');
            }
            if (lowerMessage.includes('email')) {
                fields.push('admin_email');
            }
            if (lowerMessage.includes('language') || lowerMessage.includes('locale')) {
