...
export function registerPluginList() {
    registerAbility('wp-neural-admin/plugin-list', {
        ...
        // Keywords trigger this ability from natural language input.
        // The chat system does fuzzy matching, so include common variations.
        // Tip: Think about how users actually phrase requests.
        keywords: [
            'plugin',
            'plugins',
            'installed',
