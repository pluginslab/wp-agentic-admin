...
const AbilityCard = ({ ability, onExecute, isExecuting }) => {
    ...
    return (
        <div className={`wp-agentic-admin-ability-card ${isDestructive ? 'wp-agentic-admin-ability-card--destructive' : ''}`}>
...
const ResultPanel = ({ result, onClear }) => {
    ...
    return (
        <div className={`wp-agentic-admin-result-panel ${isError ? 'wp-agentic-admin-result-panel--error' : 'wp-agentic-admin-result-panel--success'}`}>
        ...
        <div className="wp-agentic-admin-ability-browser">
            <div className="wp-agentic-admin-ability-browser__header">
                ...
                <p className="description">
                    Test abilities manually by clicking Execute. Includes WordPress core and Agentic Admin abilities.
                </p>
                <button type="button" className="button" onClick={loadAbilities}>
                    Refresh
                </button>
