        ...
        <div className="wp-agentic-admin-model-status">
            ...
            {isInLoadingState && (
                <div className="wp-agentic-admin-loading-card">
                    <div className="wp-agentic-admin-loading-card__header">
                        <span className="wp-agentic-admin-loading-card__icon">{loadingStage.icon}</span>
                        ...
                        <span className="wp-agentic-admin-loading-card__percent">{displayProgress}%</span>
                    </div>
            ...
            {!isInLoadingState && (
                <div className="wp-agentic-admin-status">
                    <span className={`wp-agentic-admin-status__indicator ${getStatusClass()}`} />
                    <div className="wp-agentic-admin-status__info">
                        ...
                        {status === 'ready' && loadedModelInfo && (
                            <span className="wp-agentic-admin-status__model-details">
                                {isServiceWorkerMode && (
                                    <span className="wp-agentic-admin-status__mode-badge wp-agentic-admin-status__mode-badge--persistent" title="Model persists across page navigations">
                                        Persistent
                                    </span>
                                )}
                                ...
                                {contextUsage && (
                                    <span className={`wp-agentic-admin-status__context ${contextUsage.isCritical ? 'context--critical' : contextUsage.isHigh ? 'context--high' : ''}`}>
                                        {' · '}
